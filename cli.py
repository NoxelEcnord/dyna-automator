...
app = typer.Typer(
    name="dyna",
    help="[bold cyan]Dyna-Automator:[/bold cyan] A modern, dynamic web automation CLI (by NoxelEcnord).",
...
def shot_cli(
    ...
    output: Annotated[str, typer.Option("--output", "-o", help="The output filename for the screenshot (e.g., homepage.png).")] = "screenshot.png", # FIX APPLIED HERE
):
    """
